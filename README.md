...
<body>
    ...
    <div class="mobile-menu" id="mobileMenu">
        ...
        <div style="margin-top: 2rem;">
            <a href="https://wa.me/5492914327031" target="_blank" class="btn btn-whatsapp" style="margin-bottom: 1rem;">
                💬 WhatsApp
            </a>
        </div>
    </div>
        ...
        <div class="container">
            <div class="about-content">
                <div class="about-text">
                    ...
                    <p>
                        Con más de 28 años de dedicación y experiencia en el campo farmacéutico, la Farmacéutica Patricia Victoria Nieto, egresada de la Universidad de San Luis, lidera nuestro equipo con un compromiso inquebrantable hacia la excelencia y la innovación en elaboración magistral.
                    </p>
                    <p>
                        Nuestro laboratorio farmacéutico se mantiene siempre a la vanguardia y cumple con las más estrictas normas de calidad farmacéutica, garantizando la máxima eficacia y seguridad en cada preparación.
                    </p>
                    
                    <ul class="about-features">
                        <li>Laboratorio certificado siempre a la vanguardia</li>
    ...
    <script>
        ...
        // Mobile Menu Toggle (Proper implementation)
